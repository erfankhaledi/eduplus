                    ...
                    <div className="row">
                            ...
                            <div className="blog-card">
                                <div className="card-img">
                                    <a href="blog-details.html">
                                        <img src="assets/img/our-blog/v2/blog-img-1.jpg" alt="blog-img" />
                                    </a>
                                </div>
                                ...
                                <div className="card-footer">
                                    <div className="all-btn">
                                        <a href="#" className="btn-p icon-v2">Read More</a>
                                    </div>
                                    <div className="footer-comments">
                                        <div className="comments-icon">
                                            <i className="my-icon icon-comments"></i>
                                        </div>
                                ...
                                <div className="card-date">
                                    <div className="date-icon">
                                        <i className="my-icon icon-calander-2"></i>
                                    </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                            <div className="blog-card">
                                <div className="card-img">
                                    <a href="blog-details.html">
                                        <img src="assets/img/our-blog/v2/blog-img-2.jpg" alt="blog-img" />
                                    </a>
                                </div>
                                <div className="card-body">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                            <div className="blog-card">
                                <div className="card-img">
                                    <a href="blog-details.html">
                                        <img src="assets/img/our-blog/v2/blog-img-3.jpg" alt="blog-img" />
                                    </a>
                                </div>
                                <div className="card-body">
                                    <h3 className="title"><a href="blog-details.html">Continuing Education: Essential Concepts for Students</a></h3>
                                    <p className="para">These specialized memberships are designed to make school accessible and affordable for specific positions.</p>
                                </div>
                                <div className="card-footer">
                                    <div className="all-btn">
