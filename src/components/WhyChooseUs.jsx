                    ...
                    <div className="col-lg-7">
                        <div className="section-title">
                            <div className="section-title-inner">
                                ...
                                <h2 className="big-title s-color-white aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">We focus on offering your educational platform</h2>
                                <p className="title-para sp-color-white aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <ul className="chooses-skill-items v2">
                            <li data-aos="fade-up" data-aos-duration="800" data-aos-delay="100" className='aos-init aos-animate'>
                            ...
                            <li data-aos="fade-up" data-aos-duration="800" data-aos-delay="300" className='aos-init aos-animate'>
                                <div className="skill-icon">
                            ...
                            <li data-aos="fade-up" data-aos-duration="800" data-aos-delay="500" className='aos-init aos-animate'>
                                <div className="skill-icon">
