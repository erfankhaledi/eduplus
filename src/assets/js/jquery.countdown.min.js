!function(t) {
    ...
    function e(f) {
        return function(t) {
            var e, s, i = t.match(/%(-|!)?[A-Z]{1}(:[^;]+;)?/gi);
            if (i)
                for (var o = 0, n = i.length; o < n; ++o) {
                    var a = i[o].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/)
                      , h = (s = (s = a[0]).toString().replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"),
                    new RegExp(s))
                      , l = a[1] || ""
                      , r = a[3] || ""
                      , c = null
                    ...
                    s = "s",
                    a = "",
                    (r = r) && (s = 1 === (r = r.replace(/(:|;|\s)/gi, "").split(/\,/)).length ? r[0] : (a = r[0],
                    r[1])),
                    c = 1 < Math.abs(e) ? s : a),
                    "" === l && c < 10 && (c = "0" + c.toString()),
                    t = t.replace(h, c.toString()))
                }
            return t.replace(/%%/, "%")
        }
    }
    ...
    function a(t, e, s) {
        ...
        this.$el.on("finish.countdown", s)) : this.options = i.extend({}, n, s)),
        this.setFinalDate(e),
        !1 === this.options.defer && this.start()
    }
    var s = new RegExp(s.join("|"))
      , u = {
        Y: "years",
        m: "months",
        n: "daysToMonth",
    ...
    i.fn.countdown = function() {
        ...
        return this.each(function() {
            ...
            void 0 !== e ? (t = o[e],
            e = s[0],
            a.prototype.hasOwnProperty(e) ? t[e].apply(t, s.slice(1)) : null === String(e).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (t.setFinalDate.call(t, e),
            t.start()) : i.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, e))) : new a(this,s[0],s[1])
        })
    }
});
